	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h4 class="modal-title" id="detail-nip">
					</h3>
					<ul class="nav nav-tabs">
						<li class="active">
							<a href="#Personal" data-toggle="tab"> Data Personal</a>
						</li>
						<li class="">
							<a href="#Pendidikan" data-toggle="tab">Riwayat Pendidikan</a>
						</li>
						<li class="">
							<a href="#Pangkat" data-toggle="tab">Riwayat Pangkat</a>
						</li>
						<li class="">
							<a href="#Jabatan" data-toggle="tab">Riwayat Jabatan</a>
						</li>
						<li class="">
							<a href="#Kerja" data-toggle="tab">Riwayat Unit Kerja</a>
						</li>
						<li class="">
							<a href="#Mengajar" data-toggle="tab">Riwayat Mengajar</a>
						</li>
						<li class="">
							<a href="#Bimbingan" data-toggle="tab">Riwayat Bimbingan</a>
						</li>
						<li class="">
							<a href="#Artikel" data-toggle="tab">Data Artikel</a>
						</li>
					</ul>
						...
						<div class="tab-pane fade " id="Artikel">
							<div class="row">
								<div class="col-md-12">
									<div class="card ">
										<div class="content">
											<table id="table_artikel_repository" class="table table-striped">
												<thead>
													<tr>
														<th>No.</th>
														<th>Type</th>
